...
export default function Menu({
  ...
  return (
    <div className={`flex flex-col items-start md:gap-6 gap-[24px] ${styleList}`}>
            ...
            >
              {item.child ? (
                ...
                <a href={item.path} onClick={clickEvent} className="">
                  <span
                    className="font-medium text-[17px] md:py-2 md:px-4 pb-2 md:cursor-pointer md:rounded-full md:transition-all md:duration-500 md:ease-in-out hover:bg-primary hover:text-white "
                  >
                    {item.name}
                  </span>
                </a>
